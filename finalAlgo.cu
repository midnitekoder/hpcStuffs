...
__global__ insertionSortParallel(int *d_x,int *d_y, int *d_z,long long *d_indexOrder, long long *d_partition_begin, long long *d_partition_last,long long numPartitions, long long count, int *d_labels,long long *d_queue,long long *d_front,long long *d_rear,long long *d_numGroups, long long *d_neighbours)
{
...
//search for front element combinations and update
